...
public class VoUsersj {
    ...
    private String secondervicename;
	...
	public String getSecondervicename() {
		return secondervicename;
	}

	public void setSecondervicename(String secondervicename) {
		this.secondervicename = secondervicename;
	}
