package com.accp.vo.th;

import java.util.Date;

public class MerchantCollectionUserVo {
		...
		public String getShangjiaNames() {
			return shangjiaNames;
		}

		public void setShangjiaNames(String shangjiaNames) {
			this.shangjiaNames = shangjiaNames;
		}

		private String shangjiaNames;
